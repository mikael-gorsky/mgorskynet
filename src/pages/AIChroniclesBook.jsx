    ...
    <main className="pt-48 pb-24 px-6 md:px-12 max-w-screen-xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        <article className="col-span-12 md:col-span-7 space-y-16">
          ...
          <blockquote className="pl-8 border-l border-primary/30 py-2">
            ...
            <cite className="font-label text-[0.6875rem] uppercase tracking-widest text-secondary mt-4 block not-italic">&mdash; Draft Preface, Page 14</cite>
          </blockquote>
        ...
        <aside className="col-span-12 md:col-span-4 md:col-start-9 space-y-12">
          <div className="card card-widget p-10">
            ...
            <div className="space-y-6">
              ...
              <div><span className="block text-xs text-secondary/60 mb-1">Target Release</span><span className="font-body text-sm text-on-surface">Winter 2025</span></div>
              <div><span className="block text-xs text-secondary/60 mb-1">Format</span><span className="font-body text-sm text-on-surface">Hardcover Monograph / Digital Archive</span></div>
              <div><span className="block text-xs text-secondary/60 mb-1">Publisher</span><span className="font-body text-sm text-on-surface italic">In Negotiation</span></div>
            </div>
          </div>
      ...
      <section className="mt-48 card card-featured py-24 px-8 md:px-24">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-12 flex justify-center"><div className="h-px w-12 bg-primary/30"></div></div>
        </div>
      </section>
