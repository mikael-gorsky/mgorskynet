    ...
    <main className="pt-40 pb-24 px-6 md:px-12 max-w-screen-xl mx-auto">
      ...
      <section className="mb-40">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-7">
            <div className="aspect-[16/9] overflow-hidden bg-surface-container-high opacity-80"></div>
          </div>
        ...
        <div className="md:col-span-8 flex flex-col md:flex-row gap-12">
          <div className="flex-1">
            ...
            <p className="font-body text-on-surface-variant leading-relaxed mb-6">
              I work with leadership teams to audit existing AI roadmaps and identify structural vulnerabilities in their data architecture.
            </p>
            <a href="mailto:hello@mgorsky.net" className="flex items-center gap-2 text-primary group">
              <span className="font-label text-xs uppercase tracking-widest">Inquire for Private Sessions</span>
          ...
          <div className="flex-1">
            ...
            <p className="font-body text-on-surface-variant leading-relaxed mb-6">
              Tailored intensives for engineering and product leads focusing on agentic systems and production-grade LLM implementation.
            </p>
            <a href="mailto:hello@mgorsky.net" className="flex items-center gap-2 text-primary group">
              <span className="font-label text-xs uppercase tracking-widest">View Availability</span>
              <span className="material-symbols-outlined text-sm">arrow_forward</span>
            </a>
          </div>
        </div>
